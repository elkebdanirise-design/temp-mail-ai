            ...
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              {isAuthLoading ? (
                ...
                <>
                  ...
                  {!isPremium && (
                    <Button asChild className="relative overflow-hidden mesh-gradient-btn-intense header-cta-frame header-cta-static hover:scale-[1.02] transition-transform rounded-lg md:rounded-xl h-[46px] md:h-10 w-[88px] md:w-[100px] p-0">
                  ...
                  <Button 
                    asChild 
                    variant="ghost" 
                    className="geometric-diamond-btn header-cta-frame h-[46px] md:h-10 w-[88px] md:w-[100px] p-0 rounded-lg md:rounded-xl"
                  >
