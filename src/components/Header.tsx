      ...
      <header className="py-4 md:py-8 lg:py-10 relative z-20 animate-fade-in">
        <div className="container mx-auto px-2 sm:px-6 md:px-8">
          <div className="flex items-center justify-between gap-4 sm:gap-6 md:gap-8">
            {/* Left section: Mobile menu + Logo - aligned on same horizontal line */}
            <div className="flex items-center gap-1 md:gap-0 ml-0">
              ...
              {/* Unified brand unit - aligned horizontally with buttons */}
            ...
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              {isAuthLoading ? (
                ...
                <>
                  {/* Pro Button - 1% larger with perfect centering */}
                  {!isPremium && (
                    <Button asChild className="relative overflow-hidden mesh-gradient-btn-intense header-cta-frame header-cta-static hover:scale-[1.02] transition-transform rounded-lg md:rounded-xl h-[44px] md:h-10 w-[101px] md:w-[101px] p-0">
                  ...
                  {/* Login Button - 1% larger with perfect centering */}
                  <Button 
                    asChild 
                    variant="ghost" 
                    className="geometric-diamond-btn header-cta-frame h-[44px] md:h-10 w-[101px] md:w-[101px] p-0 rounded-lg md:rounded-xl"
                  >
