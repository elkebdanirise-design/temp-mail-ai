    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h4 className="font-medium text-sm mb-1 text-foreground/90">Upgrade to Pro Systems</h4>

          <p className="text-xs text-muted-foreground line-clamp-2 mb-2">
            See plans & pricing to unlock unlimited emails, custom domains, and priority support.
          </p>
